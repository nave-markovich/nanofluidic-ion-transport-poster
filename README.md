...
Our study evaluates a steady-state, convection-less symmetric binary electrolyte ($D_{\pm} = D$ and $z_{\pm} = \pm z$) described by non-dimensional **Poisson-Boltzmann equations**:
